...
mod tests {
    ...
    fn a_block_renders_claudes_stop_dialect() {
        let facts = StopFacts {
            ...
            turn: Turn { final_text: "summary".into(), launches: vec![], refusals_emitted: 0, asks_the_human: false, user_asked: false, narration: String::new(), degraded_consumed: 0, seats_invoked: vec![], gate_ran: true },
